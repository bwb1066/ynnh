...
function renderResult(result, searchTerms, titleTag) {
  ...
  if (result.image) {
    ...
    wrapper.className = 'aem-search-result-image';
  ...
  if (result.title) {
    ...
    title.className = 'aem-search-result-title';
...
function clearSearchResults(block) {
  const searchResults = block.querySelector('.aem-search-results');
...
function searchResultsContainer(block) {
  ...
  results.className = 'aem-search-results';
...
function searchInput(block, config) {
  ...
  input.className = 'aem-search-input';
...
function searchBox(block, config) {
  ...
  box.classList.add('aem-search-box');
  box.append(
    searchIcon(),
